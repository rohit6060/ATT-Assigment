...
const HomeIcon = ({fill = '#888'}) => {
    return (
        <>
        <svg id="Capa_1" enable-background="new 0 0 512.039 512.039" fill={fill} className="icon" viewBox="0 0 512.039 512.039" width="512" xmlns="http://www.w3.org/2000/svg">
            <g>
                <g>
